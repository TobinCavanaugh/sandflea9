...
Copy-Item "pci_output.log" "pci_output_prev.log" -Force -ErrorAction SilentlyContinue

Get-Date -Format "yyyy-MM-dd HH:mm:ss" | Set-Content "pci_output.log"

Get-Content "pci_output.log" -Wait